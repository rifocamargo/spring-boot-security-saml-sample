...
openssl s_client -host $IDP_HOST -port $IDP_PORT -prexit -showcerts </c/Desenv/repositorios/spring-boot-security-saml-sample/src/main/resources/saml | sed -ne '/-BEGIN CERTIFICATE-/,/-END CERTIFICATE-/p' > $CERTIFICATE_FILE
